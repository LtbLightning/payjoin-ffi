...
#[uniffi::export]
trait SaveSenderCallback: Send + Sync {
    fn save(&self, sender: Vec<u8>) -> Result<SenderToken, ImplementationError>;
}

// The callback to load a sender from a token
#[uniffi::export]
trait LoadSenderCallback: Send + Sync {
